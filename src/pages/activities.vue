  ...
  data () {
    return {
      activitiesList: [
        {
        title: "象棋比赛",
        content: "暖夕阳第一届人民公园老年象棋比赛。"
      }, {
        title: "迎春植树活动",
        content: "为了迎接春天到来，我们组织了这次迎春活动，让我们为大自然奉献绿色。"
      }, {
        title: "北坡远足活动",
        content: "温度逐渐回暖，让我们一起出门走走路，锻炼身体，轻松交友。"
      }, {
        title: "元旦文艺汇演",
        content: "我们暖夕阳这个大家庭在一起过元旦，准备好一个拿手的节目展示给大家吧。"
      }, {
        title: "暖夕阳科普知识讲座（一）",
        content: "我们最有爱心的志愿者们第一次为这个大家庭的老人们准备了这次的关于老人饮食方面的科普知识讲座"
      }
    ]
    };
  },
  mounted: function(){
    axios.post('http://www.xerus.cn/nanan/public/activities',)
    .then(res=>{
...
<style>
  ...
  .activitiesBox{
    width: 80%;
    margin: 0 auto;
    border-bottom: 1px dotted #ff7761
  }
  .activitiesHeader{
    text-align: center;
    width: 20%;
